...
const Tags = () => {
    ...
    },
    {
        id:2,
        tagName: "Python",
        tagDesc: "Pyhton is a multi-Paradigm, dynamically typed, multipurpose programming language. It is designed to be quick to learn, understand, and use, and enforces a clean and uniform syntax."
    },
    {
        id:3,
        tagName: "C#",
        tagDesc: "(C# 9Pronounced 'see sharp') is a high level, statically typed, multi- paradigm programming language developed by microsoft."
    },
    {
        id:4,
        tagName: "Java",
        tagDesc: "Java is high-level object oriented programming language.Use this tag when you're having problems using or understanding the language itself. "
    },
    {
        id:5,
        tagName: "php",
    ...
    },
    {
        id:9,
        tagName: "Reactjs",
        tagDesc: "React is ajavascript library for building user interfaces. It uses a declarative, component-based paradigm and aaims to be both efficient and flexible."
    },
    {
        id:10,
        tagName: "node.js",
